...
@Autonomous(name="PowerShotBlueRight", group="BionicBot")
public class PowerShotBlueRight extends LinearOpMode
{
...
public void runOpMode()
{
    ...
    DriveBackwardDistance(.3,30);
    TurnLeftDistance(.3,3);
    robot.leftShooter.setPower(.446);
    robot.rightShooter.setPower(-.446);
    Shoot(.446,12000);

...
@Autonomous(name="PowerShotRedLeft", group="BionicBot")
public class PowerShotRedLeft extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        TurnRightDistance(.3,5);
        robot.leftShooter.setPower(.447);
        robot.rightShooter.setPower(-.447);
        Shoot(.447,12000);
        TurnLeftDistance(.3,5);
        StrafRightDistance(.3,15);
